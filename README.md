...
/ “Time wastes too fast… the days and hours    \
| of it… are flying over our heads like        |
| little clouds on a windy day, never to       |
| return more – everything presses on –        |
| whilst thou art twisting the lock, - see!    |
| it grows grey… and every time I kiss thy     |
| hand to bid adieu, and every absence which   |
| follows it, are preludes to that eternal     |
